...
@testset "B-Spline: Basis Function Tests" begin
    ...
    derivatives = Splines.BSpline.basisFunctionsDerivatives(i,u,p,n,U)
    # println("derivatives: ")
    # display(derivatives)
    # println()
    # println("actual:")
...
@testset "B-Spline: Curve Tests" begin
    ...
    d = 1
    curveDerivatives = Splines.BSpline.curveDerivatives1(n, p, U, P, u, d)
    ...
    r1 = 0
    r2 = n
    cprime = Splines.BSpline.curveDerivativeControlPoints(n, p, U, P, d, r1, r2)
